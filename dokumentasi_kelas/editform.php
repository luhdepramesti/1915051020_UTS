	...
	if(isset($_POST['btn_save_updates']))
	{
		...
		if($imgFile)
		{
			...
			{			
				...
				{
					$errMSG = "Maaf, file Anda terlalu besar, kurang dari 5MB";
				}
			}
			else
			{
				$errMSG = "Maaf, hanya file JPG, JPEG, PNG & GIF yang diperbolehkan.";		
			}	
		}
		else
		{
...
<div class="col-md-6 col-md-offset-3">
	...
	<div class="page-header">
    	<h1 class="h2">Update Dokumen. / <a class="btn btn-default" href="dokumen.php"> <span class="glyphicon glyphicon-eye-open"></span> &nbsp; lihat semua </a></h1>
    </div>
...
<form method="post" enctype="multipart/form-data" class="form-horizontal">
    ...
    <tr>
        ...
        <a class="btn btn-default" href="dokumen.php"> <span class="glyphicon glyphicon-backward"></span> Cancel </a>
